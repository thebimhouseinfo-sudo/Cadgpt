...
const CORE_TOOLS = [
  ...
  { name: "asset_import", class: "libraries", summary: "Copy a user Lisp/Job folder into CadGPT AppData and register its lightweight index." },
  { name: "asset_export", class: "libraries", summary: "Copy one managed Lisp/Job library from CadGPT AppData to a user folder." },
  { name: "asset_register_external", class: "libraries", summary: "Register and index a user Lisp/Job folder in place without copying it." },
  { name: "job_list", class: "workflow.jobs", summary: "List concrete Jobs registered from managed user Job Libraries." },
  { name: "job_get", class: "workflow.jobs", summary: "Load one registered Job and identify direct (.py) versus reasoning (.md) execution." },
  { name: "job_run_direct", class: "workflow.jobs", summary: "Run one registered direct Python Job through CadGPT's fixed Python runtime without shell or model planning." },
